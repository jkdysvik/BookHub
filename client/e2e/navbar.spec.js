...
test('should navigate to the homepage when pressing the logo', async ({ page }) => {
    // Navigate to a book page
    await page.goto('http://localhost:5173/project2/book/65535349180c5749fb9f3ecd');
...
test('should clear search input when remove button is clicked', async ({ page }) => {
...
test('should not trigger search when clicking on the Search icon without a query', async ({ page }) => {
