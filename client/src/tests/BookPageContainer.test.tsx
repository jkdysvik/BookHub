...
describe("BookCardContainer Test", () => {
    ...
    test("Check book information", async () => {
        ...
        expect(screen.getByText(mockBook.author)).toHaveTextContent(mockBook.author);
        expect(screen.getByText(mockBook.year.toString())).toHaveTextContent(mockBook.year.toString());
        expect(screen.getByText(mockBook.rating.toString())).toHaveTextContent(mockBook.rating.toString());
